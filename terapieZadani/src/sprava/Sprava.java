 ...
 * alert je určen pro ošetření chyb - mohou se tím nhradit vystavování výjimek
 * logger je učen pro monitorování vkládání a odebírání termíů ze seznamu.
 *
...
public interface Sprava extends Iterable<Termin> {
     ...
     * @throws SpravceException
     */
    default Termin najdiDalsiVolnyTermin(LocalDate odkdy, LocalDate dokdy)
            throws SpravceException {
